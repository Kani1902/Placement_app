  ...
  const handleRoundSelect = async (round, roundIndex) => {
    ...
    try {
      ...
      if (roundIndex === 0) {
        ...
        const previousRound = selectedDriveForRounds.selectionRounds[roundIndex - 1];
      ...
      const validStudents = studentsToShow.filter(student => student && student._id);
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {drive.companyDescription && (
                      <div>
                        ...
                        <p className="text-gray-600 mt-1 text-justify break-words">{drive.companyDescription}</p>
                      </div>
                    )}
                  </div>
                </div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {drive.ctcBreakdown.otherBenefits && (
                        <div>
                          ...
                          <p className="text-gray-600 mt-1 text-justify break-words">{drive.ctcBreakdown.otherBenefits}</p>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              <div className="space-y-6 min-w-0">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex flex-wrap">
                      ...
                      <span className="text-gray-600">
                        {drive.eligibility?.minCGPA || drive.eligibility?.cgpa || 'Not specified'}
                      </span>
                    </div>
                    <div className="flex flex-wrap">
                      <span className="font-medium text-gray-700 w-32 flex-shrink-0">Max Backlogs:</span>
                      <span className="text-gray-600">
                        {drive.eligibility?.maxBacklogs !== undefined ? drive.eligibility.maxBacklogs : 'Not specified'}
                      </span>
                    </div>
                    <div>
                      <span className="font-medium text-gray-700">Departments:</span>
                      <p className="text-gray-600 mt-1 break-words">
                        {(drive.eligibility?.allowedDepartments?.length > 0 || drive.eligibility?.departments?.length > 0)
                          ? (drive.eligibility?.allowedDepartments || drive.eligibility?.departments).join(', ') 
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">
                        {(drive.eligibility?.allowedBatches?.length > 0 || drive.eligibility?.batches?.length > 0)
                          ? (drive.eligibility?.allowedBatches || drive.eligibility?.batches).join(', ') 
                          : 'All batches allowed'}
                      </p>
                    </div>
                  </div>
                ...
                {drive.requirements && (
                  <div>
                    ...
                    <p className="text-sm text-gray-600 text-justify break-words">{drive.requirements}</p>
                  </div>
                )}
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {(drive.bondDetails?.amount || drive.bondDetails?.duration) && (
                      <>
                ...
                {/* Recruiter Contact */}
                {drive.recruiterContact && (drive.recruiterContact.name || drive.recruiterContact.email || drive.recruiterContact.phone) && (
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Recruiter Contact</h3>
                    <div className="space-y-2 text-sm">
                      {drive.recruiterContact.name && (
                        <div className="flex flex-wrap">
                          <span className="font-medium text-gray-700 w-20 flex-shrink-0">Name:</span>
                          <span className="text-gray-600 break-words">{drive.recruiterContact.name}</span>
                        </div>
                      )}
                      {drive.recruiterContact.email && (
                        <div className="flex flex-wrap">
                          <span className="font-medium text-gray-700 w-20 flex-shrink-0">Email:</span>
                          <a href={`mailto:${drive.recruiterContact.email}`} className="text-blue-600 hover:underline break-all">
                            {drive.recruiterContact.email}
                          </a>
                        </div>
                      )}
                      {drive.recruiterContact.phone && (
                        <div className="flex flex-wrap">
                          <span className="font-medium text-gray-700 w-20 flex-shrink-0">Phone:</span>
                          <a href={`tel:${drive.recruiterContact.phone}`} className="text-blue-600 hover:underline">
                            {drive.recruiterContact.phone}
                          </a>
                        </div>
                      )}
                ...
                <div key={drive._id} className="bg-white p-6 rounded-lg shadow">
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      ...
                      {driveEnded && drive.placedStudents && drive.placedStudents.length > 0 && (
                        <button
                          ...
                          className="px-4 py-2 bg-purple-100 text-purple-700 hover:bg-purple-200 rounded-lg font-medium text-sm"
                        >
                          Placed Students ({drive.placedStudents.length})
                        </button>
                      )}
                  ...
                  {hasSelectionRounds && (
                    <div className="mt-6 p-4 bg-gray-50 rounded-lg min-h-[120px]">
                      <h4 className="font-medium text-gray-900 mb-4 text-lg">Selection Rounds:</h4>
                        ...
                        <div className="max-h-96 overflow-y-auto border rounded-lg">
                          {!roundApplicants || roundApplicants.length === 0 ? (
                            ...
                            <div className="space-y-2 p-2">
                              {roundApplicants.filter(student => student && student._id).map((student) => (
                                <div
                                  key={student._id}
                                  className={`p-3 border rounded cursor-pointer transition-colors ${
                                    selectedStudentsForRound.includes(student._id)
