    ...
    try {
      ...
      setFormData({
        ...
        eligibility: {
          ...
          allowedDepartments: drive.eligibility?.allowedDepartments || drive.eligibility?.departments || [],
          allowedBatches: drive.eligibility?.allowedBatches || drive.eligibility?.batches || [],
