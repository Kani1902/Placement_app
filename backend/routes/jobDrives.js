  ...
  try {
    ...
    const jobDriveData = {
      ...
      eligibility: {
        ...
        allowedDepartments: req.body.eligibility?.allowedDepartments || req.body.eligibility?.departments || [],
        departments: req.body.eligibility?.departments || req.body.eligibility?.allowedDepartments || [],
        allowedBatches: req.body.eligibility?.allowedBatches || req.body.eligibility?.batches || [],
        batches: req.body.eligibility?.batches || req.body.eligibility?.allowedBatches || [],
